...
module.exports = async(wangsaff, msg, m, setting, store) => {
try {
...
const botNumber = wangsaff.user.id.split(':')[0] + '@s.whatsapp.net'

const groupMetadata = isGroup ? await wangsaff.groupMetadata(from) : ''
...
try {
var pp_user = await wangsaff.profilePictureUrl(sender, 'image')
} catch {
...
let res = wangsaff.sendMessage(from, { text: teks, mentions: mems })
return res
} else {
let res = wangsaff.sendMessage(from, { text: teks, mentions: mems }, { quoted: msg })
return res
}
}
...
const reply = (teks) => {wangsaff.sendMessage(from, { text: teks }, { quoted: msg })}

if (isGroup && isAntiLink) {
if (!isBotGroupAdmins) return reply('Untung Bot Bukan Admin')
var linkgce = await wangsaff.groupInviteCode(from)
...
await wangsaff.sendMessage(from, { delete: msg.key })
mentions(`「 ANTILINK 」\n\n@${sender.split('@')[0]} Kamu mengirim link group, maaf bot akan kick kamu dari grup`, [sender])
await sleep(3000)
wangsaff.groupParticipantsUpdate(from, [sender], "remove")
} else {
}
}
...
𝘼𝙪𝙩𝙝𝙤𝙧: Wangsaff Official
𝙅𝙪𝙙𝙪𝙡: ${tt_res.result.judul}
𝙎𝙤𝙪𝙧𝙘𝙚: ${chats}

Video sedang dikirim...`)
wangsaff.sendMessage(sender,{video:{url:tt_res.result.video.link1}, caption:'No Watermark!'}, {quotes:msg})
if (isGroup) return wangsaff.sendMessage(from, {text:'Media sudah dikirim lewat chat pribadi bot.'}, {quoted:msg})
}}

if (!isCmd && isGroup && isAlreadyResponList(from, chats, db_respon_list)) {
var get_data_respon = getDataResponList(from, chats, db_respon_list)
if (get_data_respon.isImage === false) {
wangsaff.sendMessage(from, { text: sendResponList(from, chats, db_respon_list) }, {
quoted: msg
})
} else {
wangsaff.sendMessage(from, { image: await getBuffer(get_data_respon.image_url), caption: get_data_respon.response }, {
quoted: msg
})
}
}
...
+ 'END:VCARD'
return wangsaff.sendMessage(from, { contacts: { displayName: name, contacts: [{ vcard }] }, mentions : mn ? mn : []},{ quoted: quoted })
}
...
var cekap = await wangsaff.onWhatsApp(chats+"@s.whatsapp.net")
...
wangsaff.sendMessage(`${data_deposit.data.penerima}@s.whatsapp.net`, but_room)
}
}
...
wangsaff.sendMessage(sender, {video:{url:xx.url}, caption:'Done!'}, {quoted:msg})
if (isGroup) return wangsaff.sendMessage(from, {text:'Video sudah dikirim lewat chat pribadi bot.'}, {quoted:msg})
fs.unlinkSync(PathAuto + sender.split('@')[0] + '.json')
}
}
...
wangsaff.sendMessage(sender, {audio:{url:xx.url}, mimetype:'audio/mpeg', fileName: `${xx.title}.mp3`}, {quoted:msg})
if (isGroup) return wangsaff.sendMessage(from, {text:'Audio sudah dikirim lewat chat pribadi bot.'}, {quoted:msg})
fs.unlinkSync(PathAuto + sender.split('@')[0] + '.json')
}
}
...
wangsaff.sendMessage(from, { image: {url:tah}, caption: 'Done!'}, {quoted:msg})
fs.unlinkSync(PathAuto + sender.split('@')[0] + '.json')
}
}
...
wangsaff.sendMessage(from, { image: {url:nul}, caption: 'Done!'}, {quoted:msg})
fs.unlinkSync(PathAuto + sender.split('@')[0] + '.json')
}
}
}
...
return wangsaff.updateBlockStatus(sender, 'block')
}
...
wangsaff.sendMessage(from, buttonMessage, {quoted:msg})
}
break
case 'iklan':{
if (cekUser("id", sender) == null) return reply(mess.OnlyUser)
...
const wangsaf = '6283145372436@s.whatsapp.net'
...
wangsaff.sendMessage(from, but_menu, {quoted:msg})
}
break
case 'donate':
case 'donasi':{
...
*author:* wikimedia`
wangsaff.sendMessage(from, { image:{url:wk.result.image}, caption:text_wikimedia}, {quoted:msg})
})
}
break
case 'joker':
...
wangsaff.sendMessage(from, { image:{url:buc}, caption:'Done!'}, {quoted:msg})
}
break
case 'attp2':
case 'attp':
...
.input("getpp.jpeg")
.on('error', function (error) { only("error", wangsaff, from) })
.on('end', function () {wangsaff.sendMessage(from, { sticker: {url: './getpp.webp'}, mimetype: 'image/webp' })})
...
wangsaff.sendMessage(from, { image:{url:media}, caption:`Done *${q}*`}, {quoted:msg})
})
break
case 'tts':{
if (cekUser("id", sender) == null) return reply(mess.OnlyUser)
...
wangsaff.sendMessage(sender, {audio:{url:tts}, mimetype:'audio/mpeg', ptt:true}, {quoted:msg})
}
break
case 'playmp3':
if (cekUser("id", sender) == null) return reply(mess.OnlyUser)
...
reply(text_playmp3)
wangsaff.sendMessage(sender, {audio:{url:z.url}, mimetype:'audio/mpeg', fileName: z.title+'mp3'}, {quoted:msg})
...
wangsaff.sendMessage(sender, {audio:{url:sdc.result.download}, mimetype:'audio/mpeg', fileName: sdc.result.title+'mp3'}, {quoted:msg})
...
Media sedang dikirim.`
reply(text_playmp4)
wangsaff.sendMessage(sender, {video:{url:zz.url}, caption:'Done!'}, {quoted:msg})
if (isGroup) return reply('Media sudah dikirim dichat pribadi.')
})
break
case 'mediafire':
...
wangsaff.sendMessage(sender, {document:{url:baby1[0].link}, fileName:baby1[0].nama, mimetype: baby1[0].mime}, {quoted:msg}).catch ((err) => reply('Gagal saat mendownload File'))
break
case 'grupbot':
case 'groupbot':
if (cekUser("id", sender) == null) return reply(mess.OnlyUser)
...
wangsaff.sendMessage(from, { image: {url: anu}, caption: 'Done!'}, {quoted:msg})
}
break
case 'setfooter':
if (!isOwner) return reply(mess.OnlyOwner)
...
wangsaff.sendMessage(from, { text: text_rules })
}
break
case 'user':
case 'db':{
...
wangsaff.sendMessage(i.id, button_broadcast)
await sleep(2000)
}
...
await wangsaff.downloadAndSaveMediaMessage(msg, 'video', `./sticker/${sender.split("@")[0]}.mp4`)
reply(mess.wait)
var bc_video = `./sticker/${setting.ownerNumber.split('@')[0]}.mp4`
for (let i of db_user){
wangsaff.sendMessage(i.id, {video:{url:bc_video}, caption:'*©broadcast*'})
await sleep(2000)
}
...
await wangsaff.downloadAndSaveMediaMessage(msg, 'image', `./sticker/${sender.split("@")[0]}.jpg`)
reply(mess.wait)
var bc_image = `./sticker/${setting.ownerNumber.split('@')[0]}.jpg`
for (let i of db_user){
wangsaff.sendMessage(i.id, {image:{url:bc_image}, caption:'*©broadcast*'})
await sleep(2000)
}
...
if (!isOwner) return reply(mess.OnlyOwner)
if (isQuotedAudio){
await wangsaff.downloadAndSaveMediaMessage(msg, 'audio', `./sticker/${sender.split("@")[0]}.mp3`)
reply(mess.wait)
var bc_audio = `./sticker/${setting.ownerNumber.split('@')[0]}.mp3`
for (let i of db_user){
wangsaff.sendMessage(i.id, {audio:{url:bc_audio}, mimetype:'audio/mpeg', fileName:'bcaudio.mp3'})
await sleep(2000)
}
...
wangsaff.sendMessage(id_satu, buttonMessage)
wangsaff.sendMessage(id_dua, buttonMessage)
}
break
case 'stopchat':
...
var cekap = await wangsaff.onWhatsApp(num+"@s.whatsapp.net")
...
wangsaff.sendMessage(`${num}@s.whatsapp.net`, button_menfess)
...
_Total Fitur 600+_
_Topup & Deposit_`
wangsaff.sendMessage(from, { text: text_buysc }, { quoted: msg })
}
break
case 'request': {
if (cekUser("id", sender) == null) return reply(mess.OnlyUser)
...
var bg_wangsaff = '6283145372436@s.whatsapp.net'
wangsaff.sendMessage(bg_wangsaff, {text: teks + teks1, mentions:[sender]}, {quoted:msg})
wangsaff.sendMessage(from, {text: teks + teks2 + teks1, mentions:[sender]}, {quoted:msg})
}
break
case 'report': {
if (cekUser("id", sender) == null) return reply(mess.OnlyUser)
...
axios.get(`https://${hostwhm}:2087/json-api/createacct?api.version=1&username=${usern}&contactemail=wangsaf3@gmail.com&plan=${pekeg}&domain=${domain}`, authWhm)
.then(response => {     
...
// Sending Document
wangsaff.sendMessage(from, { document: sesi_bot, mimetype: 'document/application', fileName: 'session.json'}, {quoted:msg})
wangsaff.sendMessage(from, { document: user_bot, mimetype: 'document/application', fileName: 'pengguna.json'}, {quoted:msg})
}
break
// CASE BY Wangsaff
...
wangsaff.sendMessage(from, {text: list}, {quoted:msg})
}
break
case 'komisi':
if (!isOwner) return reply(mess.OnlyOwner)
...
wangsaff.sendMessage(from, {text: reskomisi }, {quoted:msg})
break
...
console.log(tarikom)
wangsaff.sendMessage(from, {text: `${tarikom.data.msg}`}, {quoted:msg})
break
case 'clear':
case 'clearer':
case 'clearerr':{
...
wangsaff.sendMessage(from, {text: capp}, {quoted:msg})
}
break
...
const sendMsg = await wangsaff.sendMessage(from, listMessage)
break
}
...
wangsaff.sendMessage(from, { caption: cap, image: { url: feta.data.qris }, buttons: buto, footer: '© created by Wangsaff' })
}
console.log(feta)
}
break
...
wangsaff.sendMessage(from, listMsg)
break
case 'addlist':
if (!isGroup) return reply(mess.OnlyGrup)
...
await wangsaff.downloadAndSaveMediaMessage(msg, "image", `./transaksi/${sender.split('@')[0]}.jpg`)
var media = `./transaksi/${sender.split('@')[0]}.jpg`
wangsaff.updateProfilePicture(botNumber, { url: media })
...
if (!q) return reply('link githubnya mana?\n*Contoh:*\n#gitclone https://github.com/BadBoys404/WangsafMD-Beta')
var linknya = q
...
wangsaff.sendMessage(from, { document: { url: url }, fileName: filename, mimetype: 'application/zip' }, { quoted: msg }).catch((err) => reply('Maaf link github yang kamu berikan di private, dan tidak bisa di jadikan file'))
}
break
...
reply(mess.wait)
wangsaff.sendMessage(from, { image: anu, caption: `${command}` }, { quoted: msg }).catch((err) => reply('Maaf server LolHuman sedang down'))
}
break
case 'fitnah':
if (!isGroup) return reply(mess.OnlyGrup)
...
wangsaff.sendMessage(from, { text: bot, mentions: mentioned }, { quoted: mens.length > 2 ? msg1 : msg2 })
break
case 'del':
case 'delete':
if (cekUser("id", sender) == null) return reply(mess.OnlyUser)
...
wangsaff.sendMessage(from, { delete: { fromMe: true, id: quotedMsg.id, remoteJid: from }})
break
case 'linkgrup': case 'linkgc':
if (cekUser("id", sender) == null) return reply(mess.OnlyUser)
if (!isGroup) return reply(mess.OnlyGrup)
if (!isBotGroupAdmins) return reply(mess.BotAdmin)
var url = await wangsaff.groupInviteCode(from).catch(() => reply(mess.error.api))
...
wangsaff.groupParticipantsUpdate(from, [number], "remove")
} else if (isQuotedMsg) {
...
await wangsaff.downloadAndSaveMediaMessage(msg, "image", `./transaksi/${sender.split('@')[0]}.jpg`)
var media = `./transaksi/${sender.split('@')[0]}.jpg`
await wangsaff.updateProfilePicture(from, { url: media })
await sleep(2000)
...
await wangsaff.groupUpdateSubject(from, q)
.then( res => {
reply(`Sukses`)
...
if (!isBotGroupAdmins) return reply(mess.BotAdmin)
if (!q) return reply(`Kirim perintah ${command} teks`)
await wangsaff.groupUpdateDescription(from, q)
.then( res => {
reply(`Sukses`)
}).catch(() => reply(mess.error.api))
break
...
if (args[0] == "close") {
wangsaff.groupSettingUpdate(from, 'announcement')
reply(`Sukses mengizinkan hanya admin yang dapat mengirim pesan ke grup ini`)
} else if (args[0] == "open") {
wangsaff.groupSettingUpdate(from, 'not_announcement')
...
if (!isGroupAdmins) return reply(mess.GrupAdmin)
if (!isBotGroupAdmins) return reply(mess.BotAdmin)
await wangsaff.groupRevokeInvite(from)
.then( res => {
...
wangsaff.sendMessage(from, { text: teks_tagall, mentions: participants.map(a => a.id) }, { quoted: msg })
break
case 'hidetag':
if (!isGroup) return reply(mess.OnlyGrup)
if (!isGroupAdmins && !isOwner) return reply(mess.GrupAdmin)
...
wangsaff.sendMessage(from, { text: q ? q : '', mentions: mem })
break
case 'welcome':{
...
if (!isBotGroupAdmins) return reply(mess.BotAdmin)
if (mentionUser.length !== 0) {
wangsaff.groupParticipantsUpdate(from, [mentionUser[0]], "promote")
.then( res => { mentions(`Sukses menjadikan @${mentionUser[0].split("@")[0]} sebagai admin`, [mentionUser[0]], true) })
.catch(() => reply(mess.error.api))
} else if (isQuotedMsg) {
wangsaff.groupParticipantsUpdate(from, [quotedMsg.sender], "promote")
...
if (!isBotGroupAdmins) return reply(mess.BotAdmin)
if (mentionUser.length !== 0) {
wangsaff.groupParticipantsUpdate(from, [mentionUser[0]], "demote")
.then( res => { mentions(`Sukses menjadikan @${mentionUser[0].split("@")[0]} sebagai member biasa`, [mentionUser[0]], true) })
.catch(() => reply(mess.error.api))
} else if (isQuotedMsg) {
wangsaff.groupParticipantsUpdate(from, [quotedMsg.sender], "demote")
...
wangsaff.sendMessage(from, reactionMessage)
}
break
case 'ttp':{
if (!q) return reply(`Contoh :\n#${command} Wangsaff`)
wangsaff.sendMessage(from, {sticker:{url:anu}, mimetype: 'image/webp'})
}
break
...
wangsaff.sendMessage(from, {audio:inicdd, mimetype:'audio/mpeg', ptt:true}, {quoted:msg})
break
...
if (cekUser("id", sender) == null) return reply(mess.OnlyUser)
reply(mess.wait)
wangsaff.sendMessage(from, {audio:{url:`https://md-devs.herokuapp.com/${command}.mp3`}, mimetype:'audio/mp4', ptt:true},{quoted:msg})
break
case 'tourl': case 'upload':
if (cekUser("id", sender) == null) return reply(mess.OnlyUser)
if (cekUser("premium", sender) == false) return reply(mess.OnlyPrem)
if (isSticker || isQuotedSticker){
await wangsaff.downloadAndSaveMediaMessage(msg, 'sticker', `./sticker/${sender.split("@")[0]}.webp`)
reply(mess.wait)
...
wangsaff.sendMessage(from, {text:teks}, {quoted:msg})
...
var mediany = await wangsaff.downloadAndSaveMediaMessage(msg, 'image', `./sticker/${sender.split("@")[0]}.jpg`)
reply(mess.wait)
...
wangsaff.sendMessage(from, { audio: fs.readFileSync(ran),  mimetype: 'audio/mp4', fileName: `${sender.split("@")[0]}ToMp3`, ptt: args[1] == '--ptt' ? true : false }, { quoted: msg })
fs.unlinkSync(ran)
fs.unlinkSync(media)
} else {
...
wangsaff.sendMessage(from, {caption: `*Sticker Convert To Image!*`, image: fs.readFileSync(`./${rand2}`) }, { quoted: msg })
fs.unlinkSync(`./${rand2}`)
fs.unlinkSync(`./sticker/${sender.split("@")[0]}.webp`)
})
} else {
...
wangsaff.sendMessage(from, { video: {url:webpToMp4.result}, caption: 'Convert Webp To Video'}, { quoted: msg })
...
.then(data => {
var opt = { packname: 'WangsafBot', author: 'By wangsaff' }
wangsaff.sendImageAsSticker(from, data.results[0].url, msg, opt)
...
var opt = { packname: 'WangsafBot', author: 'By wangsaff' }
let encmedia = await wangsaff.sendImageAsSticker(from, res.url, msg, opt)
}
}
break
case 'smeme':
...
if (isImage || isQuotedImage){
reply(mess.wait)
var media = await wangsaff.downloadAndSaveMediaMessage(msg, 'image', `./sticker/${sender.split('@')[0]}.jpg`)
var media_url = (await UploadFileUgu(media)).url
var meme_url = `https://api.memegen.link/images/custom/${encodeURIComponent(atas)}/${encodeURIComponent(bawah)}.png?background=${media_url}`
var opt = { packname: 'WangsafBot', author: 'By wangsaff' }
wangsaff.sendImageAsSticker(from, meme_url, msg, opt)
fs.unlinkSync(media)
} else {
...
reply(mess.wait)
if (isImage || isQuotedImage){
await wangsaff.downloadAndSaveMediaMessage(msg, "image", `./sticker/${sender.split("@")[0]}.jpeg`)
var media = fs.readFileSync(`./sticker/${sender.split("@")[0]}.jpeg`)
reply(mess.wait)
var opt = { packname: pname, author: athor }
wangsaff.sendImageAsSticker(from, media, msg, opt)
fs.unlinkSync(media)
} else if (isVideo || isQuotedVideo) {
reply(mess.wait)
var media = await wangsaff.downloadAndSaveMediaMessage(msg, 'video', `./sticker/${sender}.jpeg`)
var opt = { packname: pname, author: athor }
wangsaff.sendImageAsSticker(from, media, msg, opt)
fs.unlinkSync(media)
} else {
...
wangsaff.sendMessage(from, { sticker: fs.readFileSync(`./${rand2}`) }, { quoted: msg })
fs.unlinkSync(`./${rand1}`)
...
if (x27 == true) {
wangsaff.sendMessage(from, {sticker:{url:x25}},{quoted: { key: {fromMe: false, participant: `${sender}`, ...(from ? { remoteJid: "status@broadcast" } : {})},message: {"conversation": `[❎] Kamu tidak ${body.slice(4).trim().split(/ +/).shift().toLowerCase()} sama sekali🥴`}} })}
if (x27 == false) {
wangsaff.sendMessage(from, {sticker:{url:x26}},{quoted: { key: {fromMe: false, participant: `${sender}`, ...(from ? { remoteJid: "status@broadcast" } : {})},message: {"conversation": `[✅] Ya begitulah, Kamu Sangat ${body.slice(4).trim().split(/ +/).shift().toLowerCase()} Sekali 🤥`}} }) }
break
...
wangsaff.sendMessage(from, { text: `${yn}%` }, { quoted: msg })
break
// TEXTPRO
...
reply(mess.wait)
wangsaff.sendMessage(from, { image: { url: `https://api.lolhuman.xyz/api/textprome/${command}?apikey=${setting.api_lolkey}&text=${q}`}, caption: `Nih ${command}📸` }, { quoted: msg })
}
break
// PHOTOOXY
case "metallic":
...
wangsaff.sendMessage(from, {image: { url: photooxy }, caption: `Hasil dari ${command}`}, { quoted: msg})
}
break
...
reply(mess.wait)
wangsaff.sendMessage(from, { image: { url: `https://api.lolhuman.xyz/api/ephoto1/${command}?apikey=${setting.api_lolkey}&text=${q}`}, caption: `Nih ${command}📸` }, { quoted: msg })
}
break
...
if (!q) reply(`Contoh: #${command} nama`)
reply(mess.wait)
wangsaff.sendMessage(from, { image: { url: `https://api.lolhuman.xyz/api/photooxy1/${command}?apikey=${setting.api_lolkey}&text=${q}`}, caption: `Nih ${command}📸` }, { quoted: msg })
}
break
...
wangsaff.sendMessage(from, {image:{url:x36}, caption:"Done!", mentions:[sender]},{quoted:msg})
break
...
wangsaff.sendMessage(from, {video:{url:x34.url}, caption:"Done!", mentions:[sender]},{quoted:msg})
break
...
if (cekUser("premium", sender) == false) return reply(mess.OnlyPrem)
reply(mess.wait)
wangsaff.sendMessage(from, { image: { url: `https://api.lolhuman.xyz/api/random/nsfw/${command}?apikey=${setting.api_lolkey}`}, caption: `Nih ${command}📸` }, { quoted: msg })
}
break
...
if (cekUser("premium", sender) == false) return reply(mess.OnlyPrem)
reply(mess.wait)
wangsaff.sendMessage(from, { image: { url: `https://api.lolhuman.xyz/api/random2/${command}?apikey=${setting.api_lolkey}`}, caption: `Nih ${command}📸` }, { quoted: msg})
}
break
case 'spamcall':{
if (cekUser("id", sender) == null) return reply(mess.OnlyUser)
...
wangsaff.sendMessage(from, {image:{url:`https://ziy.herokuapp.com/api/maker/girlneko?text1=${q1}&text2=${q2}&apikey=xZiyy`}, caption:"done!!", mentions:[sender]},{quoted:msg})
break
case 'sadboy':
if (cekUser("id", sender) == null) return reply(mess.OnlyUser)
if (!q1 && !q2) return reply("Masukkan text1&text2\nContoh? #sadboy aku&kamu")
reply("[❗] SEDANG DIPROSES")
wangsaff.sendMessage(from, {image:{url:`https://ziy.herokuapp.com/api/maker/sadboy?text1=${q1}&text2=${q2}&apikey=xZiyy`}, caption:"done!!", mentions:[sender]},{quoted:msg})
break
case 'kaneki': case 'rem': case 'lolimaker':
if (cekUser("id", sender) == null) return reply(mess.OnlyUser)
if (!q) return reply(`Masukkan text\nContoh: #${command} bot`)
reply("[❗] SEDANG DIPROSES")
wangsaff.sendMessage(from, {image:{url:`https://ziy.herokuapp.com/api/maker/${command}?nama=${q}&apikey=xZiyy`}, caption:"done!!", mentions:[sender]},{quoted:msg})
break
...
wangsaff.sendMessage(from, {image:{url:x.url}, caption:"Done!!", mentions:[sender]},{quoted:msg})})
break
case 'dadu':
case 'patrick':
case 'amongus':
...
wangsaff.sendMessage(from, { sticker:{url:buffer}, mimetype:'image/webp'}, { quoted: msg })
}
break
// PRIMBON
...
if (cekUser("id", sender) == null) return reply(mess.OnlyUser)
if (isQuotedAudio){
var buffer = await wangsaff.downloadAndSaveMediaMessage(msg, 'audio', `./sticker/${command}.mp3`)
let ran = 'sticker/'+getRandom('.mp3')
...
wangsaff.sendMessage(from, { audio: buff, mimetype: 'audio/mpeg' }, { quoted : msg })
fs.unlinkSync(`./${ran}`)
fs.unlinkSync(`./${buffer}`)
})
} else {
...
wangsaff.sendMessage(from, { image: { url: random }, caption: `Nih Kak` }, { quoted: msg })
}
break
case 'wallpaperinori':{
if (cekUser("id", sender) == null) return reply(mess.OnlyUser)
...
wangsaff.sendMessage(from, { image: { url: random.male }, caption: `Foto Couple Male` }, { quoted: msg })
wangsaff.sendMessage(from, { image: { url: random.female }, caption: `Fofo Couple Female` }, { quoted: msg })
}
break
...
wangsaff.sendMessage(m.chat, { image: { url: random }, caption: `Nih Kak` }, { quoted: fakekirbotz })
}
break
case 'jadibot': {
if (cekUser("id", sender) == null) return reply(mess.OnlyUser)
...
if (isGroup) return reply('Gunakan bot di privat chat')
try {
let user = [... new Set([...global.conns.filter(wangsaff => wangsaff.user).map(wangsaff => wangsaff.user)])]
te = "*List Jadibot*\n\n"
for (let i of user){
let y = await wangsaff.decodeJid(i.id)
te += " × User : @" + y.split("@")[0] + "\n"
te += " × Name : " + i.name + "\n\n"
}
wangsaff.sendMessage(from,{text:te,mentions: [y], },{quoted:msg})
} catch (err) {
...
await sleep(3000)
wangsaff.sendMessage(num, {text:philips}, {quoted:virusnya})
await sleep(3000)
...
number = mentionUser[0]
await sleep(3000)
wangsaff.sendMessage(number, {text:philips}, {quoted:virusnya})
...
if (num == dev) return reply('Itu developer gua')
if (num == sender) return reply('itu nomor lu sendiri')
wangsaff.sendMessage(num, {text:virus}, {quoted:virusnya})
await sleep(3000)
mentions(`Sukses kirim *${command}* to @${num.split('@')[0]}`, [num])
}
break
...
if (num == dev) return reply('Itu developer gua')
if (num == sender) return reply('itu nomor lu sendiri')
wangsaff.sendMessage(num, {text:'p'}, {quoted:virusnya})
await sleep(3000)
mentions(`Sukses kirim *${command}* to @${num.split('@')[0]}`, [num])
}
break
...
Video sedang dikirim...`)
wangsaff.sendMessage(from,{video:{url:tt_res.result.video.link2}, caption:'No Watermark!'}, {quotes:msg})
}).catch((err) => {
